...
**There are chunks of example code that you should copy and run yourself**. The chunks include demonstrations that have little meaning without seeing the output they create. The examples also include many commonly-used functions that are not discussed in the text. 
...
* Advanced R assumes use of Hadley Wickham's Tidyverse set of packages. This manual is relevant whether you're using Tidyverse packages or not. For data analysis many people prefer alternatives to Tidyverse packages (discussed in section \@ref(packages-why-not-dplyr)).
