...
* <u>Base R for quick and dirty graphs</u>, when you just want to see what the data look like, and you don't need to show it to anyone else. For example, base R's `plot()` was used in the section \@ref(object-types-loops) code.
